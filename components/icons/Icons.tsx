...
export const PurchasesIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className || iconClass} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const SupplierIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className={iconClass} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h2a1 1 0 001-1V7a1 1 0 00-1-1h-2v10z" />
  </svg>
);
...
export const PendingPaymentsIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || iconClass} fill="none" viewBox="0 0 24 24" stroke="currentColor">
